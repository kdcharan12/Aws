...
let conn, db, users, data,menu,menus;
const app = express();
...
app.post('/sendemail', async function(req, res){
    try
    {
        var transport = nodemailer.createTransport({
            ...
            port: 445,
            secure: true,
            auth:{user: "kotagiricharandeep@gmail.com", pass: "fcuiyeriztzburlg"}
        });

        var emaildata = {
            from: "kotagiricharandeep@gmail.com",
            to: "pcschaitanyasai@gmail.com",
